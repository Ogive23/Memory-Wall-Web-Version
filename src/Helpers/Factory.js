...
export class Factory {
    getObjectFromJson(dataObject, type) {
        switch (type) {
            case 'memory':
                return new Memory(dataObject['id'],
                    ...
                    new User(dataObject['createdBy']['id'], dataObject['createdBy']['name'], dataObject['createdBy']['userName'], dataObject['createdBy']['email'], dataObject['createdBy']['image']));
            case 'user':
                return new User(dataObject['id'], dataObject['name'], dataObject['userName'], dataObject['email'], dataObject['image']);
            default:
