...
const memories = [
    {
        ...
        'age': '17',
        'brief': 'This impressive paella is a perfect party dish and a fun meal to cook together with your guests. Add 1 cup of frozen peas along with the mussels, if you like.',
        'lifeStory': '',
    ...
    render() {
        ...
        try {
            ...
            return (
                <Container>
                    <Row xs={1} md={3}>
                        {this.state.memories.map((memory) => { return <Col key={memory.id}><MemoryCard memory={memory} /></Col> })}
                    </Row>
                </Container>
            );
